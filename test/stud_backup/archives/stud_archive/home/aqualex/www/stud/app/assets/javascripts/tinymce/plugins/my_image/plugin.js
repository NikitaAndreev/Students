...
tinymce.PluginManager.add('my_image', function(editor) {
	...
	function showDialog(imageList) {
        ...
        function openMyFileManager() {
            src = win.find('#src')[0];
            window.open('manager?tag_name='+src._id,'','width=800,height=540 ,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=yes');
        }
